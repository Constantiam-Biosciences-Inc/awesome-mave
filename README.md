...
* [MoCHI](https://github.com/lehner-lab/MoCHI) \- \[python] \- Neural networks to fit interpretable models and quantify energies, energetic couplings, epistasis, and allostery from deep mutational scanning data.
